...
/// <summary>
/// MAVLink SCALED_IMU message (ID 26). The IMU readings in SI units in NED body frame.
/// </summary>
public readonly record struct ScaledImu : IMavlinkMessage
{
    ...
    /// <inheritdoc/>
    public uint MessageId => 26;

    /// <inheritdoc/>
    public byte CrcExtra => 170;
    ...
    /// <summary>Deserializes a <see cref="ScaledImu"/> from a raw payload span.</summary>
    public static ScaledImu Deserialize(ReadOnlySpan<byte> buffer) =>
        new()
        {
