...
/// <summary>
/// MAVLink MISSION_REQUEST message (ID 40). Request the information of the mission item with the sequence number seq.
/// </summary>
public readonly record struct MissionRequest : IMavlinkMessage
{
    ...
    /// <summary>Deserializes a <see cref="MissionRequest"/> from a raw payload span.</summary>
    public static MissionRequest Deserialize(ReadOnlySpan<byte> buffer)
    {
