...
/// <summary>
/// MAVLink MISSION_SET_CURRENT message (ID 41). Set the mission item with sequence number to be the current item.
/// </summary>
public readonly record struct MissionSetCurrent : IMavlinkMessage
{
    ...
    /// <summary>Deserializes a <see cref="MissionSetCurrent"/> from a raw payload span.</summary>
    public static MissionSetCurrent Deserialize(ReadOnlySpan<byte> buffer) =>
        new()
        {
